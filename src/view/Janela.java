...
public class Janela extends JFrame {
	...
	public JMenuItem menuListarTudo;
	private JMenu menuPropriedades;
	public JMenuItem menuPropriedadesCriar;
	...
	public void inicializar() {
		...
		menuListarTudo = new JMenuItem("Listar Tudo");
		menuPropriedadesCriar = new JMenuItem("Criar tabela");		
		menuPropriedadesQuantidade = new JMenuItem("Quantidade de registros");
		menuPropriedadesEsvaziar = new JMenuItem("Esvaziar tabela");
		...
		menuListar.add(menuListarTudo);
		menuPropriedades.add(menuPropriedadesCriar);
	...
	public void janelaListar(String[][] conteudo, String titulo) {

		limparPainel();
		jLTitulo = new JLabel();
		
		String [] colunas = {"Matrícula", "Nome", "Setor", "Salário", "Classe"}; 
		...
		tabela.getColumnModel().getColumn(4).setPreferredWidth(27);
